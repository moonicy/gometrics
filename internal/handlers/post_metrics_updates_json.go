...
// PostMetricsUpdatesJSON обрабатывает HTTP-запрос для обновления значений метрик.
// Получает имена метрик, типы и значения из json и обновляет хранилище метрик.
